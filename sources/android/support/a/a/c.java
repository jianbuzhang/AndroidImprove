...
class c {
    ...
    public static class b {
        ...
        private static void a(Path path, float[] fArr, char c, char c2, float[] fArr2) {
            ...
            float f6 = fArr[5];
            switch (c2) {
                case j.AppCompatTheme_imageButtonStyle /*65*/:
                case j.AppCompatTheme_textColorAlertDialogListItem /*97*/:
                    i = 7;
                    break;
                case j.AppCompatTheme_textAppearanceSearchResultSubtitle /*67*/:
                case j.AppCompatTheme_buttonBarNegativeButtonStyle /*99*/:
                    i = 6;
                    break;
                case j.AppCompatTheme_listPreferredItemHeightLarge /*72*/:
                case j.AppCompatTheme_colorControlNormal /*86*/:
                case j.AppCompatTheme_checkboxStyle /*104*/:
                case 'v':
                    i = 1;
                    break;
                case j.AppCompatTheme_listPopupWindowStyle /*76*/:
                case j.AppCompatTheme_textAppearanceListItem /*77*/:
                case j.AppCompatTheme_colorPrimaryDark /*84*/:
                ...
                case j.AppCompatTheme_colorPrimary /*83*/:
                case j.AppCompatTheme_switchStyle /*113*/:
                case 's':
                    i = 4;
                    break;
                case j.AppCompatTheme_colorSwitchThumbNormal /*90*/:
                case 'z':
                    path.close();
                    path.moveTo(f5, f6);
                    f4 = f6;

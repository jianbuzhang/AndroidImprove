    ...
    void a(AttributeSet attributeSet, int i) {
        ...
        try {
            if (obtainStyledAttributes.hasValue(j.CompoundButton_android_button)) {
                ...
                if (resourceId != 0) {
                    this.a.setButtonDrawable(android.support.v7.c.a.b.b(this.a.getContext(), resourceId));
                }
            }
            ...
            if (obtainStyledAttributes.hasValue(j.CompoundButton_buttonTintMode)) {
                b.a(this.a, ad.a(obtainStyledAttributes.getInt(j.CompoundButton_buttonTintMode, -1), null));
            }
